...
**URL**: [www.arbosolucoes.com](https://www.arbosolucoes.com) | **Repo**: [GitHub](https://github.com/rsilvagit/arbo-sparkle-refresh)
...
A decisão de não usar React, Vue ou qualquer framework SPA foi intencional:
